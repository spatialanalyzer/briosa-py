...
class FeatureCheckReportingOptions(_message.Message):
    __slots__ = ("show_feature_control_frame_summary", "include_title", "show_datum_and_tolerance_summary", "show_feature_summary", "show_point_details", "show_lower_tier_tables")
    ...
    def __init__(self, show_feature_control_frame_summary: bool = ..., include_title: bool = ..., show_datum_and_tolerance_summary: bool = ..., show_feature_summary: bool = ..., show_point_details: bool = ..., show_lower_tier_tables: bool = ...) -> None: ...
...
class SetFeatureCheckReportingOptionsRequest(_message.Message):
    __slots__ = ("feature_check", "show_feature_control_frame_summary", "include_title", "show_datum_and_tolerance_summary", "show_feature_summary", "show_point_details_summary", "show_lower_tier_tables")
    FEATURE_CHECK_FIELD_NUMBER: _ClassVar[int]
    SHOW_FEATURE_CONTROL_FRAME_SUMMARY_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_TITLE_FIELD_NUMBER: _ClassVar[int]
    SHOW_DATUM_AND_TOLERANCE_SUMMARY_FIELD_NUMBER: _ClassVar[int]
    ...
    show_lower_tier_tables: bool
    def __init__(self, feature_check: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionItemName, _Mapping]] = ..., show_feature_control_frame_summary: bool = ..., include_title: bool = ..., show_datum_and_tolerance_summary: bool = ..., show_feature_summary: bool = ..., show_point_details_summary: bool = ..., show_lower_tier_tables: bool = ...) -> None: ...
