...
class GetConePropertiesResult(_message.Message):
    __slots__ = ("cone_end_point_in_working_coordinates", "cone_axis_in_working_coordinates", "cone_length", "cone_theta_start", "cone_theta_span", "cone_included_angle", "execution")
...
class MakeCylinderFitProfileRequest(_message.Message):
    __slots__ = ("fit_profile_name", "measured_side_for_radial_offset", "override_radial_offset_1_0_use_current", "lock_radius_1_0_do_not_lock", "locked_radius_fit_method", "cylinder_computation_technique", "use_exhaustive_search", "make_cardinal_points", "cardinal_pt_1_begin_pt", "cardinal_pt_2_end_pt", "cardinal_pt_3_center")
    FIT_PROFILE_NAME_FIELD_NUMBER: _ClassVar[int]
    MEASURED_SIDE_FOR_RADIAL_OFFSET_FIELD_NUMBER: _ClassVar[int]
    OVERRIDE_RADIAL_OFFSET_1_0_USE_CURRENT_FIELD_NUMBER: _ClassVar[int]
    LOCK_RADIUS_1_0_DO_NOT_LOCK_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, fit_profile_name: _Optional[str] = ..., measured_side_for_radial_offset: _Optional[_Union[_spatial_analyzer_values_pb2.MeasuredSideForRadialOffset, str]] = ..., override_radial_offset_1_0_use_current: _Optional[float] = ..., lock_radius_1_0_do_not_lock: _Optional[float] = ..., locked_radius_fit_method: _Optional[_Union[_spatial_analyzer_values_pb2.FitMethod, str]] = ..., cylinder_computation_technique: _Optional[_Union[_spatial_analyzer_values_pb2.CompTechnique, str]] = ..., use_exhaustive_search: bool = ..., make_cardinal_points: bool = ..., cardinal_pt_1_begin_pt: bool = ..., cardinal_pt_2_end_pt: bool = ..., cardinal_pt_3_center: bool = ...) -> None: ...
...
class ReComputeCalculatedItemsRequest(_message.Message):
    __slots__ = ("targets_from_shots", "hidden_points", "relationships")
    ...
    hidden_points: bool
    relationships: bool
    def __init__(self, targets_from_shots: bool = ..., hidden_points: bool = ..., relationships: bool = ...) -> None: ...
