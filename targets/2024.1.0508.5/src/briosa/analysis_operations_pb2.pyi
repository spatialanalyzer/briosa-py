...
class GetConePropertiesResult(_message.Message):
    __slots__ = ("cone_end_point", "cone_axis", "cone_length", "cone_theta_start", "cone_theta_span", "cone_included_angle", "execution")
...
class MakeCylinderFitProfileRequest(_message.Message):
    __slots__ = ("fit_profile_name", "measured_side_for_radial_offset", "override_radial_offset", "lock_radius", "locked_radius_fit_method", "cylinder_computation_technique", "use_exhaustive_search", "make_cardinal_points", "cardinal_pt_1_begin_pt", "cardinal_pt_2_end_pt", "cardinal_pt_3_center")
    FIT_PROFILE_NAME_FIELD_NUMBER: _ClassVar[int]
    MEASURED_SIDE_FOR_RADIAL_OFFSET_FIELD_NUMBER: _ClassVar[int]
    OVERRIDE_RADIAL_OFFSET_FIELD_NUMBER: _ClassVar[int]
    LOCK_RADIUS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, fit_profile_name: _Optional[str] = ..., measured_side_for_radial_offset: _Optional[_Union[_spatial_analyzer_values_pb2.MeasuredSideForRadialOffset, str]] = ..., override_radial_offset: _Optional[float] = ..., lock_radius: _Optional[float] = ..., locked_radius_fit_method: _Optional[_Union[_spatial_analyzer_values_pb2.FitMethod, str]] = ..., cylinder_computation_technique: _Optional[_Union[_spatial_analyzer_values_pb2.CompTechnique, str]] = ..., use_exhaustive_search: bool = ..., make_cardinal_points: bool = ..., cardinal_pt_1_begin_pt: bool = ..., cardinal_pt_2_end_pt: bool = ..., cardinal_pt_3_center: bool = ...) -> None: ...
