...
class WaveBOperationsMixin(_WaveBClient):
    async def run_crib_sheet(
        ...
        """Run Crib Sheet using the selected instrument."""
        await self._invoke_mp_operation(
            ...
            "instrument_operations.run_crib_sheet",
            {
                ...
                "crib_sheet_name": crib_sheet_name,
    ...
    async def project_objects(
        ...
        """Project Objects; the input iterable is materialized once before the RPC."""
        await self._invoke_mp_operation(
            "briosa.InstrumentOperations",
            "ProjectObjects",
            "instrument_operations.project_objects",
            {"instrument": instrument, "objects_to_project": objects_to_project},
            None,
        )
    ...
    async def construct_objects_from_surface_faces_runtime_select(
        ...
        *,
        ...
        await self._invoke_mp_operation(
            ...
            {
                "construct_planes": construct_planes,
                "construct_cylinders": construct_cylinders,
                "construct_spheres": construct_spheres,
                "construct_cones": construct_cones,
                "construct_lines": construct_lines,
                "construct_points": construct_points,
                "construct_circles": construct_circles,
            },
            None,
        )
        return None
