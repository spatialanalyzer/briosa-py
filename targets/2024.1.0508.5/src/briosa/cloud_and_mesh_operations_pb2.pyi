...
class FilterCloudsToVectorGroupsResolvePointsRequest(_message.Message):
    __slots__ = ("cloud_names", "vector_group_names", "output_group_name", "minimum_proximity", "maximum_proximity", "maximum_distance_from_vector_begin", "minimum_number_of_required_points", "output_type")
    CLOUD_NAMES_FIELD_NUMBER: _ClassVar[int]
