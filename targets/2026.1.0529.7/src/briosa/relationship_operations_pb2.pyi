...
class SetGeomRelationshipAutoMeasureNominalFeatureRequest(_message.Message):
    __slots__ = ("relationship_name", "trap_clouds", "instrument_id", "measurement_mode")
    RELATIONSHIP_NAME_FIELD_NUMBER: _ClassVar[int]
    TRAP_CLOUDS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, relationship_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionObjectName, _Mapping]] = ..., trap_clouds: bool = ..., instrument_id: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionInstrumentId, _Mapping]] = ..., measurement_mode: _Optional[str] = ...) -> None: ...
...
class AutoFilterCloudsToNominalGeometry2DRequest(_message.Message):
    __slots__ = ("auto_filter_target_relationships", "clouds", "cloud_thinning_settings", "filter_proximity_settings_2d", "geometry_extraction_tolerance", "use_feature_specific_filter_settings")
    ...
    USE_FEATURE_SPECIFIC_FILTER_SETTINGS_FIELD_NUMBER: _ClassVar[int]
...
class AutoFilterCloudsToNominalGeometry3DRequest(_message.Message):
    __slots__ = ("auto_filter_target_relationships", "clouds", "cloud_thinning_settings", "filter_proximity_settings_3d", "use_feature_specific_filter_settings")
    AUTO_FILTER_TARGET_RELATIONSHIPS_FIELD_NUMBER: _ClassVar[int]
    CLOUDS_FIELD_NUMBER: _ClassVar[int]
    CLOUD_THINNING_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    ...
    use_feature_specific_filter_settings: bool
    def __init__(self, auto_filter_target_relationships: _Optional[_Iterable[_Union[_spatial_analyzer_values_pb2.CollectionItemName, _Mapping]]] = ..., clouds: _Optional[_Iterable[_Union[_spatial_analyzer_values_pb2.CollectionObjectName, _Mapping]]] = ..., cloud_thinning_settings: _Optional[_Union[_spatial_analyzer_values_pb2.CloudThinningOptions, _Mapping]] = ..., filter_proximity_settings_3d: _Optional[_Union[FilterProximitySettings, _Mapping]] = ..., use_feature_specific_filter_settings: bool = ...) -> None: ...
...
class DoRelationshipFitRequest(_message.Message):
    __slots__ = ("collection_containing_relationships", "objects_to_move", "instruments_to_move", "solver_mode", "motion_to_allow", "enable_randomized_start", "use_fit_dialog")
    ...
    ENABLE_RANDOMIZED_START_FIELD_NUMBER: _ClassVar[int]
...
class ExtractGeometryFromPointCloudsRequest(_message.Message):
    __slots__ = ("relationship_name", "geometry_type", "cloud_name", "bounding_points", "seed_points", "tolerance", "reverse_normal", "planar_point_count")
    RELATIONSHIP_NAME_FIELD_NUMBER: _ClassVar[int]
    GEOMETRY_TYPE_FIELD_NUMBER: _ClassVar[int]
    CLOUD_NAME_FIELD_NUMBER: _ClassVar[int]
    BOUNDING_POINTS_FIELD_NUMBER: _ClassVar[int]
    SEED_POINTS_FIELD_NUMBER: _ClassVar[int]
    TOLERANCE_FIELD_NUMBER: _ClassVar[int]
    REVERSE_NORMAL_FIELD_NUMBER: _ClassVar[int]
    PLANAR_POINT_COUNT_FIELD_NUMBER: _ClassVar[int]
    relationship_name: _spatial_analyzer_values_pb2.CollectionItemName
    geometry_type: _spatial_analyzer_values_pb2.GeometryType
    cloud_name: _spatial_analyzer_values_pb2.CollectionObjectName
    bounding_points: PointNameList
    seed_points: _containers.RepeatedCompositeFieldContainer[_spatial_analyzer_values_pb2.PointName]
    tolerance: float
    reverse_normal: bool
    planar_point_count: int
    def __init__(self, relationship_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionItemName, _Mapping]] = ..., geometry_type: _Optional[_Union[_spatial_analyzer_values_pb2.GeometryType, str]] = ..., cloud_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionObjectName, _Mapping]] = ..., bounding_points: _Optional[_Union[PointNameList, _Mapping]] = ..., seed_points: _Optional[_Iterable[_Union[_spatial_analyzer_values_pb2.PointName, _Mapping]]] = ..., tolerance: _Optional[float] = ..., reverse_normal: bool = ..., planar_point_count: _Optional[int] = ...) -> None: ...

class ExtractGeometryFromPointCloudsResult(_message.Message):
    __slots__ = ("execution",)
    EXECUTION_FIELD_NUMBER: _ClassVar[int]
    execution: _operation_outcomes_pb2.MpExecutionDetails
    def __init__(self, execution: _Optional[_Union[_operation_outcomes_pb2.MpExecutionDetails, _Mapping]] = ...) -> None: ...
...
class GetGeneralRelationshipStatisticsResult(_message.Message):
    __slots__ = ("absolute_max_deviation", "rms", "has_signed_deviation", "signed_max_deviation", "signed_min_deviation", "execution")
    ...
    execution: _operation_outcomes_pb2.MpExecutionDetails
    def __init__(self, absolute_max_deviation: _Optional[float] = ..., rms: _Optional[float] = ..., has_signed_deviation: bool = ..., signed_max_deviation: _Optional[float] = ..., signed_min_deviation: _Optional[float] = ..., execution: _Optional[_Union[_operation_outcomes_pb2.MpExecutionDetails, _Mapping]] = ...) -> None: ...
...
class GetPointsToObjectsRelationshipStatisticsResult(_message.Message):
    __slots__ = ("absolute_max_deviation", "max_deviation", "min_deviation", "avg_deviation", "rms", "candidate_point_count", "sampled_point_count", "rejected_point_count", "used_point_count", "out_of_tolerance_point_count", "execution")
    ABSOLUTE_MAX_DEVIATION_FIELD_NUMBER: _ClassVar[int]
    MAX_DEVIATION_FIELD_NUMBER: _ClassVar[int]
    MIN_DEVIATION_FIELD_NUMBER: _ClassVar[int]
    AVG_DEVIATION_FIELD_NUMBER: _ClassVar[int]
    RMS_FIELD_NUMBER: _ClassVar[int]
...
class GetRelationshipSigmoidalGapFitConstraintsRequest(_message.Message):
    __slots__ = ("relationship_name",)
    RELATIONSHIP_NAME_FIELD_NUMBER: _ClassVar[int]
    relationship_name: _spatial_analyzer_values_pb2.CollectionItemName
    def __init__(self, relationship_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionItemName, _Mapping]] = ...) -> None: ...

class GetRelationshipSigmoidalGapFitConstraintsResult(_message.Message):
    __slots__ = ("constraints", "execution")
    CONSTRAINTS_FIELD_NUMBER: _ClassVar[int]
    EXECUTION_FIELD_NUMBER: _ClassVar[int]
    constraints: SigmoidalGapFitConstraints
    execution: _operation_outcomes_pb2.MpExecutionDetails
    def __init__(self, constraints: _Optional[_Union[SigmoidalGapFitConstraints, _Mapping]] = ..., execution: _Optional[_Union[_operation_outcomes_pb2.MpExecutionDetails, _Mapping]] = ...) -> None: ...
...
class MakeCloudToSwatchRelationshipRequest(_message.Message):
    __slots__ = ("relationship_name", "input_cloud_name", "surface_face_list", "reference_point", "maximum_radial_offset", "minimum_axial_offset", "maximum_axial_offset", "cardinal_point_group_name")
    RELATIONSHIP_NAME_FIELD_NUMBER: _ClassVar[int]
    INPUT_CLOUD_NAME_FIELD_NUMBER: _ClassVar[int]
    SURFACE_FACE_LIST_FIELD_NUMBER: _ClassVar[int]
    REFERENCE_POINT_FIELD_NUMBER: _ClassVar[int]
    MAXIMUM_RADIAL_OFFSET_FIELD_NUMBER: _ClassVar[int]
    MINIMUM_AXIAL_OFFSET_FIELD_NUMBER: _ClassVar[int]
    MAXIMUM_AXIAL_OFFSET_FIELD_NUMBER: _ClassVar[int]
    CARDINAL_POINT_GROUP_NAME_FIELD_NUMBER: _ClassVar[int]
    relationship_name: _spatial_analyzer_values_pb2.CollectionItemName
    input_cloud_name: _spatial_analyzer_values_pb2.CollectionObjectName
    ...
    cardinal_point_group_name: _spatial_analyzer_values_pb2.CollectionObjectName
    def __init__(self, relationship_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionItemName, _Mapping]] = ..., input_cloud_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionObjectName, _Mapping]] = ..., surface_face_list: _Optional[str] = ..., reference_point: _Optional[_Union[_spatial_analyzer_values_pb2.PointName, _Mapping]] = ..., maximum_radial_offset: _Optional[float] = ..., minimum_axial_offset: _Optional[float] = ..., maximum_axial_offset: _Optional[float] = ..., cardinal_point_group_name: _Optional[_Union[_spatial_analyzer_values_pb2.CollectionObjectName, _Mapping]] = ...) -> None: ...

class MakeCloudToSwatchRelationshipResult(_message.Message):
    __slots__ = ("execution",)
    EXECUTION_FIELD_NUMBER: _ClassVar[int]
    execution: _operation_outcomes_pb2.MpExecutionDetails
    def __init__(self, execution: _Optional[_Union[_operation_outcomes_pb2.MpExecutionDetails, _Mapping]] = ...) -> None: ...
