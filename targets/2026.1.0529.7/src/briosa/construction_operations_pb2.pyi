...
class SystemString(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    SYSTEM_STRING_LICENSE_USER_NAME: _ClassVar[SystemString]
    SYSTEM_STRING_WINDOWS_USER_NAME: _ClassVar[SystemString]
    SYSTEM_STRING_COMPUTER_NAME: _ClassVar[SystemString]
...
SYSTEM_STRING_LICENSE_USER_NAME: SystemString
SYSTEM_STRING_WINDOWS_USER_NAME: SystemString
SYSTEM_STRING_COMPUTER_NAME: SystemString
...
class ConstructEllipseRequest(_message.Message):
...
class ConstructEllipseResult(_message.Message):
    __slots__ = ("execution",)
    EXECUTION_FIELD_NUMBER: _ClassVar[int]
    execution: _operation_outcomes_pb2.MpExecutionDetails
    def __init__(self, execution: _Optional[_Union[_operation_outcomes_pb2.MpExecutionDetails, _Mapping]] = ...) -> None: ...
...
class ConstructObjectsFromSurfaceFacesRuntimeSelectRequest(_message.Message):
    __slots__ = ("object_type", "point_offset")
    OBJECT_TYPE_FIELD_NUMBER: _ClassVar[int]
    POINT_OFFSET_FIELD_NUMBER: _ClassVar[int]
    object_type: ConstructObjectType
    point_offset: float
    def __init__(self, object_type: _Optional[_Union[ConstructObjectType, str]] = ..., point_offset: _Optional[float] = ...) -> None: ...
